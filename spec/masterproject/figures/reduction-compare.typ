...
#let comparison = figure(
  caption: "Nix language features and their presence in the NixLang and Garnix. For the Work of Broekhoff and Krabbers, we only count the features shown in the paper and disregard their Rocq implementation.",
  table(
