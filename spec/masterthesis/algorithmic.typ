...
*Why no LUtail (deviation from P&X).* P&X's (Rfield) search may hit a row var and then COMMITS it to contain the sought field: α ≔ (l: β | γ), fresh β γ. Two reasons we drop this:
