use crate::module::{AstPtr, BindingValue, File, Module, ModuleSourceMap, Name};
/// Lower the parser ast into Expr which is used by type inference.
use crate::{Diagnostic, DiagnosticKind};
use indexmap::IndexMap;
use la_arena::Arena;
use parser2::ast::{self, AstNode, HasStringParts, LiteralKind};
use parser2::semantic::{
...
//                                 .with_note(
//                                     FileRange::new(this.file, prev_loc),
...
//                         PathAnchor::Home
//                     }
//                     _ => PathAnchor::Relative(self.file),
//                 };
...
struct MergingEntry<'a> {
    ...
    value: Option<(AstPtr, BindingValue<'a>)>,
}
...
//                         .with_note(
//                             FileRange::new(ctx.file, prev_ptr.text_range()),
//                             "Previously defined here",
//                         ),
//                 );
//             })
